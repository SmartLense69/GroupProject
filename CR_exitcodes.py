...
An exit code is thrown everytime the program finishes with ``sys.exit()``.
"""
...
"""
If the user provided an invalid command line argument.
This most likely mean they have written the argument wrong.
"""
